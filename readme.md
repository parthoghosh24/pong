...
# Re-Pong (Pong with new multiplayer and music)
> For people who want to spend time making games instead of configuring build tools.

![License](https://img.shields.io/badge/license-MIT-green)

This is another implementation of classic Pong game using PhaserJs 3 and Colyesus. Game features music, offline and online multiplayer.
